    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark text-start font-weight-medium mb-1"><?php echo $this->lang->line('PENDING_INSTALLMENTS'); ?></h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            ...
                            <li class="breadcrumb-item text-muted active" aria-current="page"><?php echo $this->lang->line('PENDING_INSTALLMENTS'); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                                ...
                                <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                            <?php echo $this->lang->line('INSTALLMENT_NO'); ?>
                                            </th>
                                            <th>
                                    ...
                                    <tbody>
                                        <?php $i = 1;
                                        $pendingInstallments = count($searched_data) > 0 ? $searched_data : $pendingInstallments;
                                        foreach ($pendingInstallments as $inst) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $inst->installmentNumber; ?></td>
                        ...
                        <a download="" id="exportcsvbtn" href="<?php echo base_url(); ?>attachments/data/csv/getpendinginstallments.csv" class="my-3 btn btn-info"><?php echo $this->lang->line('EXPORT_AS_CSV'); ?> <i class="bi bi-filetype-csv"></i> </a>
                        <a download="" id="exportcsvbtn" href="<?php echo base_url(); ?>attachments/data/pdf/getpendinginstallments.pdf" class="my-3 btn btn-success"><?php echo $this->lang->line('EXPORT_AS_PDF'); ?> <i class="bi bi-filetype-pdf"></i> </a>
                    </div>
                </div>
            </div>
        </div>
