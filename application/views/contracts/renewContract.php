...
<div class="page-wrapper">
                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            ...
                            <li class="breadcrumb-item text-muted active" aria-current="page"><?php echo $this->lang->line('PAYMENTS'); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <?php if ($sess->ag_can_create == 1 || $sess->ag_can_update == 1) : ?>
        ...
        <?php if (!isset($contractsData[0]->contractNumber)) :
                $contractNumber = $ID;
            else :
                $contractNumber = $contractsData[0]->contractNumber;
            endif;
            ?>
            ...
            <div class="d-block mt-4">
                <button type="button" type="button" class="btn btn-sm btn-primary" onclick="openTab(event, 'Payments');">
                    <div class="tablink">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="date" id="expiryDate" name="expiryDate" class="form-control" autocomplete="off" <?php $s = date_create($contractData->expiryDate);
                                                                                                                                                            $s = date_format($s, 'Y-m-d');
                                                                                                                                                            $contractPeriod = $contractData->contractPeriod;
                                                                                                                                                            $d = date('Y-m-d', strtotime($s . ' +' . $contractPeriod . 'year'));
