          ...
          <div class="col-12 grid-margin">
            <div class="card">
              <div class="card-body">
                ...
                <form id="frmcontracts" class="form-sample" action="<?php echo base_url() . "contracts/insertContracts"; ?>" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          ...
                          <select name="propertyId" id="propertyId" class="form-select form-control" required>
                            ...
                            ?>
                              <option data-r="<?php echo $row->rCount; ?>" data-c="<?php echo $row->cCount ?>" value="<?php echo $row->pId ?>"> <?php echo $row->propertyName ?></option>;
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <select id="tenantId" name="tenantId" class="form-control form-select" required>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <select id="units" name="units[]" class="form-control form-select" required multiple>
                            <option value="" selected disabled hidden><?php echo $this->lang->line('SELECT_TENANT'); ?></option>
                          </select>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" id="expiryDate" name="expiryDate" class="form-control" autocomplete="off" readonly />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="number" id="rentAmount" name="rentAmount" class="form-control" autocomplete="off" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="12" <?php if (isset($contractsData)) { ?>value="<?php echo $contractsData->mobileNumber;
                                                                                                                                                                                                                                                                                                    ?>" <?php } ?> required="required" />
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="number" id="waterFee" name="waterFee" class="form-control" autocomplete="off" <?php if (isset($contractsData)) { ?>value="<?php echo $contractsData->propertyId;
                                                                                                                                                                  ?>" <?php } ?> required="required" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="number" id="electricityFee" name="electricityFee" class="form-control" autocomplete="off" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="12" <?php if (isset($contractsData)) { ?>value="<?php echo $contractsData->mobileNumber;
                                                                                                                                                                                                                                                                                                            ?>" <?php } ?> required="required" />
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="number" id="otherFee" name="otherFee" class="form-control" autocomplete="off" <?php if (isset($contractsData)) { ?>value="<?php echo $contractsData->propertyId;
                                                                                                                                                                  ?>" <?php } ?> required="required" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="number" id="totalRent" name="totalRent" class="form-control" autocomplete="off" required="required" />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <?php //if (isset($contractsData)) { ?>value="<?php //echo $contractsData->propertyId;?>" <?php //} ?> required="required" />
                    <!--    </div>-->
                    <!--  </div>-->
                    <!--</div>-->
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="number" id="agencyFee" name="agencyFee" class="form-control" autocomplete="off" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="12" <?php if (isset($contractsData)) { ?>value="<?php echo $contractsData->mobileNumber;
                                                                                                                                                                                                                                                                                                  ?>" <?php } ?> required="required" />
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="number" id="mgmtFeesPercentage" name="mgmtFeesPercentage" class="form-control" autocomplete="off" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="number" id="mgmtFeesFixed" name="mgmtFeesFixed" class="form-control" autocomplete="off" />
                        </div>
                      </div>
                    </div>
                  </div>
